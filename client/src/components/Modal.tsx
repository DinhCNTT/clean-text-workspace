...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, icon, children }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border border-slate-200 dark:border-slate-700/50 rounded-3xl p-6 md:p-8 shadow-2xl animate-slide-up overflow-hidden">
